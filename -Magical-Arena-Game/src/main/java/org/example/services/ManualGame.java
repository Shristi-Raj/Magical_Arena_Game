...
public class ManualGame extends Game {
    ...
    public void attack(Player attacker, Player defender) {
        int attackRoll = getValidRoll(attacker.getName() + "'s turn to attack. Enter attack roll (1-6) or 0 for random roll:");
        int defenseRoll = getValidRoll(defender.getName() + "'s turn to defend. Enter defense roll (1-6) or 0 for random roll:");
